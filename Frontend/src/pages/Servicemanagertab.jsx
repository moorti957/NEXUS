...
import { FaCode, FaPalette, FaChartLine, FaBullhorn, FaLightbulb } from "react-icons/fa";
...
const CATEGORIES = [
  ...
  { id: 'branding', label: 'Branding', icon: FaBullhorn },
  { id: 'consulting', label: 'Consulting', icon: FaLightbulb },
];
...
const ICON_OPTIONS = [
  ...
  { id: 'brand', label: 'Brand', icon: FaBullhorn },
  { id: 'mobile', label: 'Mobile', icon: FaMobileAlt },
  { id: 'consulting', label: 'Consulting', icon: FaLaptopCode },
  { id: 'star', label: 'Star', icon: FaStar },
  { id: 'rocket', label: 'Rocket', icon: FaRocket },
  { id: 'shield', label: 'Shield', icon: FaShieldAlt },
  ...
  export default function ServiceManagerTab() {
    ...
    const fetchServices = useCallback(async () => {
      console.log("🔥 FETCH SERVICES START");
      setLoading(true);
      try {
...
<option value="draft">Draft</option>
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              <FaCode className="text-6xl mx-auto mb-4 text-indigo-500" />
