// src/pages/ProjectDetails.jsx (updated version)
  ...
  return (
    <div className="min-h-screen pt-32 pb-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <Reveal>
          <div className="flex justify-between items-center mb-10">
            ...
            <div className="flex gap-3">
              {/* ✨ NEW: Edit Project Workspace Button */}
              <Button
                variant="glass"
                onClick={() => navigate(`/projects/${id}/workspace`, { state: { project } })}
              >
        ...
        {/* Rest of the original component remains exactly the same */}
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">{project.client?.email}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 p-6 rounded-2xl bg-white/5 border border-white/10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {project.teamMembers?.map((member) => (
              <div key={member._id} className="p-4 rounded-xl bg-white/5">
