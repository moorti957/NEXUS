...
export default function Header({ openChat }) {
        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            <div className="relative" ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div
                  className={`absolute right-0 mt-2 w-64 rounded-2xl shadow-2xl overflow-hidden transition-all duration-200 ${theme === 'dark'
                ...
                >
                  ...
                  <div className="py-2">
                    <Link
                      ...
                      className={`flex items-center gap-3 px-4 py-2.5 text-sm transition-colors ${theme === 'dark'
                        ? 'hover:bg-white/10'
                        : 'hover:bg-gray-100'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex items-center justify-between w-full text-left px-4 py-2.5 text-sm transition-colors ${theme === 'dark'
                        ? 'hover:bg-white/10'
                        : 'hover:bg-gray-100'
                        }`}
                    >
                      ...
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth="2"
                            d="M9 17v-2a4 4 0 014-4h6M9 17H7a2 2 0 01-2-2V7a2 2 0 012-2h10a2 2 0 012 2v2"
                          />
                        </svg>
                  ...
                  <div className={`border-t ${theme === 'dark' ? 'border-white/10' : 'border-gray-200'}`}>
                    <button
                      ...
                      className={`flex items-center gap-3 w-full text-left px-4 py-2.5 text-sm text-red-400 transition-colors ${theme === 'dark'
                        ? 'hover:bg-white/10'
                        : 'hover:bg-gray-100'
                        }`}
                    >
  ...
  className="magnetic-btn px-3 sm:px-5 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full text-xs sm:text-sm font-medium transition-all whitespace-nowrap"
>
  Sign In
</button>
          )}
      ...
      <div
        className={`md:hidden absolute top-full left-0 right-0 backdrop-blur-xl border-t border-white/10 transition-all duration-300 ${mobileMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
